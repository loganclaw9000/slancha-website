import{f as c,u,j as e,g as p,N as d,L as m,F as h}from"./index-JLVMZvxD.js";import{M as y}from"./index-B6QiNU4O.js";const r=[{slug:"getting-started",title:"Getting Started",section:"Introduction",order:1,body:`# Getting Started with Slancha
...
Our team can help with complex migrations involving custom models, fine-tuned weights, or enterprise deployments.`},{slug:"tutorial-support-bot",title:"Build a Customer Support Bot",section:"Tutorials",order:11,body:`# Tutorial: Build a Customer Support Bot
...
- [API Reference](/docs/api-reference) — full endpoint documentation`}],g=[{name:"Introduction",slugs:["getting-started","quickstart"]},{name:"Concepts",slugs:["architecture","how-routing-works"]},{name:"Evaluate",slugs:["evaluations"]},{name:"Deploy",slugs:["deployments"]},{name:"Post-Train",slugs:["post-training"]},{name:"Router",slugs:["router"]},{name:"API",slugs:["api-reference","models","sdks"]},{name:"Migrate",slugs:["migration"]},{name:"Tutorials",slugs:["tutorial-support-bot","tutorial-rag-pipeline","tutorial-cost-optimization"]}];function v(){const{slug:s}=c(),n=s||"getting-started",t=r.find(a=>a.slug===n);return u(t?{title:`${t.title} — Docs`,description:`Slancha documentation: ${t.title}. Learn how to evaluate, deploy, and improve AI models with the Slancha platform.`}:{}),s&&!t?e.jsx(p,{to:"/docs",replace:!0}):e.jsxs("div",{className:"page",children:[e.jsx(d,{}),e.jsxs("div",{className:"docs-layout",children:[e.jsx("aside",{className:"docs-sidebar",children:e.jsx("div",{className:"docs-sidebar-inner",children:g.map(a=>e.jsxs("div",{className:"docs-section",children:[e.jsx("h3",{className:"docs-section-title",children:a.name}),e.jsx("ul",{className:"docs-nav-list",children:a.slugs.map(o=>{const i=r.find(l=>l.slug===o);return i?e.jsx("li",{children:e.jsx(m,{to:`/docs/${o}`,className:`docs-nav-link${n===o?" active":""}`,children:i.title})},o):null})})]},a.name))})}),e.jsx("main",{className:"docs-content",children:t&&e.jsx("article",{className:"docs-article",children:e.jsx(y,{children:t.body})})})]}),e.jsx(h,{})]})}export{v as default};
