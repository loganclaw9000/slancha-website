import{u as c,j as e,a as u,N as d,L as m,F as p}from"./index-DHdUcaab.js";import{M as h}from"./index-C3FmKlN7.js";const i=[{slug:"getting-started",title:"Getting Started",section:"Introduction",order:1,body:`# Getting Started with Slancha
...
You can lock specific models by setting them in your [Router Configuration](/docs/router).`}],y=[{name:"Introduction",slugs:["getting-started","quickstart"]},{name:"Evaluate",slugs:["evaluations"]},{name:"Deploy",slugs:["deployments"]},{name:"Router",slugs:["router"]},{name:"API",slugs:["api-reference","models"]}];function v(){const{slug:s}=c(),n=s||"getting-started",a=i.find(t=>t.slug===n);return s&&!a?e.jsx(u,{to:"/docs",replace:!0}):e.jsxs("div",{className:"page",children:[e.jsx(d,{}),e.jsxs("div",{className:"docs-layout",children:[e.jsx("aside",{className:"docs-sidebar",children:e.jsx("div",{className:"docs-sidebar-inner",children:y.map(t=>e.jsxs("div",{className:"docs-section",children:[e.jsx("h3",{className:"docs-section-title",children:t.name}),e.jsx("ul",{className:"docs-nav-list",children:t.slugs.map(o=>{const r=i.find(l=>l.slug===o);return r?e.jsx("li",{children:e.jsx(m,{to:`/docs/${o}`,className:`docs-nav-link${n===o?" active":""}`,children:r.title})},o):null})})]},t.name))})}),e.jsx("main",{className:"docs-content",children:a&&e.jsx("article",{className:"docs-article",children:e.jsx(h,{children:a.body})})})]}),e.jsx(p,{})]})}export{v as default};
