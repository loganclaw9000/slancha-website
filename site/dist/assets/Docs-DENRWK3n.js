import{a as c,u,j as e,b as d,N as m,L as p,F as h}from"./index-yugR4Ld6.js";import{M as g}from"./index-ChgtfO33.js";const r=[{slug:"getting-started",title:"Getting Started",section:"Introduction",order:1,body:`# Getting Started with Slancha
...
\`\`\``}],y=[{name:"Introduction",slugs:["getting-started","quickstart"]},{name:"Evaluate",slugs:["evaluations"]},{name:"Deploy",slugs:["deployments"]},{name:"Post-Train",slugs:["post-training"]},{name:"Router",slugs:["router"]},{name:"API",slugs:["api-reference","models","sdks"]}];function _(){const{slug:n}=c(),s=n||"getting-started",t=r.find(a=>a.slug===s);return u(t?{title:`${t.title} — Docs`,description:`Slancha documentation: ${t.title}. Learn how to evaluate, deploy, and improve AI models with the Slancha platform.`}:{}),n&&!t?e.jsx(d,{to:"/docs",replace:!0}):e.jsxs("div",{className:"page",children:[e.jsx(m,{}),e.jsxs("div",{className:"docs-layout",children:[e.jsx("aside",{className:"docs-sidebar",children:e.jsx("div",{className:"docs-sidebar-inner",children:y.map(a=>e.jsxs("div",{className:"docs-section",children:[e.jsx("h3",{className:"docs-section-title",children:a.name}),e.jsx("ul",{className:"docs-nav-list",children:a.slugs.map(o=>{const i=r.find(l=>l.slug===o);return i?e.jsx("li",{children:e.jsx(p,{to:`/docs/${o}`,className:`docs-nav-link${s===o?" active":""}`,children:i.title})},o):null})})]},a.name))})}),e.jsx("main",{className:"docs-content",children:t&&e.jsx("article",{className:"docs-article",children:e.jsx(g,{children:t.body})})})]}),e.jsx(h,{})]})}export{_ as default};
