export const docs = [
  {
    ...
    order: 1,
    body: `# Getting Started with Slancha
...
For explicit control, you can still specify any model by name — the request bypasses routing and goes directly to that model.`,
  },
  {
    slug: 'api-reference',
    title: 'API Reference',
