...
# Slancha handles the infrastructure for you.`},bottomLine:"BaseTen gives you infrastructure. Slancha gives you outcomes."}},c=["Route","Analyze","Fine-tune","Optimize","Redeploy"];function y(){const{competitor:s}=u(),o=r[s];if(d({title:o?o.heroTitle:"Compare",description:o?o.metaDescription:"See how Slancha compares."}),!o)return e.jsx(m,{to:"/vs-competitors",replace:!0});const l=Object.entries(r).filter(([t])=>t!==s).map(([t,a])=>({slug:t,name:a.name,tagline:a.tagline}));return e.jsxs("div",{className:"page",children:[e.jsx(h,{}),e.jsxs("main",{id:"main-content",className:"cc-page",children:[e.jsxs("section",{className:"cc-hero",children:[e.jsx("span",{className:"cc-badge",children:"Comparison"}),e.jsx("h1",{className:"cc-title",children:o.heroTitle}),e.jsx("p",{className:"cc-subtitle",children:o.heroSubtitle}),e.jsxs("div",{className:"cc-hero-meta",children:[e.jsx("span",{className:"cc-meta-item",children:o.name}),e.jsx("span",{className:"cc-meta-sep",children:"vs"}),e.jsx("span",{className:"cc-meta-item cc-meta-slancha",children:"Slancha"})]})]}),e.jsxs("section",{className:"cc-section",children:[e.jsxs("h2",{className:"cc-section-title",children:["What is ",o.name,"?"]}),e.jsx("p",{className:"cc-overview",children:o.overview}),o.funding&&e.jsxs("p",{className:"cc-funding",children:["Funding: ",o.funding]})]}),e.jsxs("section",{className:"cc-section",children:[e.jsx("h2",{className:"cc-section-title",children:"Different philosophies"}),e.jsxs("div",{className:"cc-philosophy-grid",children:[e.jsxs("div",{className:"cc-philosophy-card",children:[e.jsx("h3",{children:o.name}),e.jsx("p",{children:o.philosophy.theirs})]}),e.jsxs("div",{className:"cc-philosophy-card cc-philosophy-slancha",children:[e.jsx("h3",{children:"Slancha"}),e.jsx("p",{children:o.philosophy.ours})]})]})]}),e.jsxs("section",{className:"cc-section",children:[e.jsx("h2",{className:"cc-section-title",children:"Feature-by-feature comparison"}),e.jsx("div",{className:"cc-table-wrap",children:e.jsxs("table",{className:"cc-table",children:[e.jsx("thead",{children:e.jsxs("tr",{children:[e.jsx("th",{children:"Capability"}),e.jsx("th",{children:o.name}),e.jsx("th",{className:"cc-slancha-col",children:"Slancha"})]})}),e.jsx("tbody",{children:o.comparison.map((t,a)=>e.jsxs("tr",{children:[e.jsx("td",{className:"cc-feature-name",children:t.feature}),e.jsx("td",{children:t.theirs}),e.jsx("td",{className:"cc-slancha-cell",children:t.ours})]},a))})]})})]}),e.jsxs("section",{className:"cc-section cc-loop-section",children:[e.jsxs("h2",{className:"cc-section-title",children:["The closed loop ",o.name," doesn't have"]}),e.jsx("p",{className:"cc-loop-desc",children:"Slancha is the only platform that closes the full optimization loop — continuously and automatically."}),e.jsxs("div",{className:"cc-loop",children:[c.map((t,a)=>e.jsxs(p.Fragment,{children:[e.jsx("span",{className:"cc-loop-step",children:t}),a<c.length-1&&e.jsx("span",{className:"cc-loop-arrow",children:"→"})]},t)),e.jsx("span",{className:"cc-loop-arrow cc-loop-return",children:"&hookleftarrow;"})]})]}),e.jsx("section",{className:"cc-section",children:e.jsxs("div",{className:"cc-choose-grid",children:[e.jsxs("div",{className:"cc-choose-card",children:[e.jsxs("h3",{children:["When to choose ",o.name]}),e.jsx("p",{children:o.whenToChooseThem}),e.jsxs("h4",{children:[o.name,"'s strengths"]}),e.jsx("ul",{children:o.strengths.map((t,a)=>e.jsx("li",{children:t},a))})]}),e.jsxs("div",{className:"cc-choose-card cc-choose-slancha",children:[e.jsx("h3",{children:"When to choose Slancha"}),e.jsx("p",{children:o.whenToChooseUs}),e.jsx("h4",{children:"Slancha's advantage"}),e.jsx("p",{className:"cc-bottom-line",children:o.bottomLine})]})]})}),e.jsxs("section",{className:"cc-section",children:[e.jsx("h2",{className:"cc-section-title",children:"Migration is simple"}),e.jsx("p",{className:"cc-migration-desc",children:"Slancha uses the OpenAI-compatible API format. Switching takes minutes, not weeks."}),e.jsxs("div",{className:"cc-code-grid",children:[e.jsxs("div",{className:"cc-code-block",children:[e.jsx("div",{className:"cc-code-header",children:e.jsxs("span",{className:"cc-code-label",children:["Before: ",o.name]})}),e.jsx("pre",{children:e.jsx("code",{children:o.migrationCode.before})})]}),e.jsxs("div",{className:"cc-code-block cc-code-slancha",children:[e.jsx("div",{className:"cc-code-header",children:e.jsx("span",{className:"cc-code-label",children:"After: Slancha"})}),e.jsx("pre",{children:e.jsx("code",{children:o.migrationCode.after})})]})]})]}),e.jsxs("section",{className:"cc-cta",children:[e.jsxs("h2",{children:["Ready to switch from ",o.name,"?"]}),e.jsx("p",{children:"Start with the free router. See cost savings from your first request. No credit card required."}),e.jsxs("div",{className:"cc-cta-buttons",children:[e.jsx(n,{to:"/pricing",className:"btn-primary",onClick:()=>i(`vs_${s}_pricing`,`vs_${s}_footer`),children:"See Pricing"}),e.jsx(n,{to:"/docs/quickstart",className:"btn-secondary",onClick:()=>i(`vs_${s}_quickstart`,`vs_${s}_footer`),children:"Read the Quickstart"})]})]}),e.jsxs("section",{className:"cc-section cc-others",children:[e.jsx("h2",{className:"cc-section-title",children:"Other comparisons"}),e.jsxs("div",{className:"cc-others-grid",children:[l.map(t=>e.jsxs(n,{to:`/vs/${t.slug}`,className:"cc-other-card",children:[e.jsxs("span",{className:"cc-other-name",children:["vs ",t.name]}),e.jsx("span",{className:"cc-other-tagline",children:t.tagline})]},t.slug)),e.jsxs(n,{to:"/vs-competitors",className:"cc-other-card",children:[e.jsx("span",{className:"cc-other-name",children:"Full Comparison"}),e.jsx("span",{className:"cc-other-tagline",children:"All competitors side-by-side"})]})]})]})]}),e.jsx(g,{})]})}export{y as default};
