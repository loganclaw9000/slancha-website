...
console.log(\`Endpoint: \${deployment.endpoint}\`);`,response:`{
  "id": "deploy_prod123",
  "name": "prod-support",
  "endpoint": "https://aogutyvup5m15h-8888.proxy.runpod.net/v1/deployments/deploy_prod123",
  "status": "active",
  "models": ["gpt-4o", "claude-sonnet-4-20250514", "ft:llama-3.1-8b:support-bot-v2"],
  "optimization_target": "cost",
  "rate_limit": 5000,
